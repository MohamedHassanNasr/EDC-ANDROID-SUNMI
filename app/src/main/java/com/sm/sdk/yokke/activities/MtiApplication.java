...
import com.sm.sdk.yokke.database.BatchRecordDB;
import com.sm.sdk.yokke.database.QrDataDB;
import com.sm.sdk.yokke.database.ReversalDataDB;
import com.sm.sdk.yokke.database.TransParamDB;
import com.sm.sdk.yokke.isopacker.IPacker;
import com.sm.sdk.yokke.isopacker.Packer;
import com.sm.sdk.yokke.utils.CacheHelper;
...
public class MtiApplication extends Application {
    public static MtiApplication app;
...
//    public IScanInterface scanInterface;
    ...
    private static ReversalDataDB reversalDataDB;
    private static ResponseCode rspCode;
    private static QrDataDB qrDataDB;
    ...
    public static void initDatabase() {
        ...
        reversalDataDB  = ReversalDataDB.getInstance();
        qrDataDB        = QrDataDB.getInstance();
    }
    ...
    public static ReversalDataDB getReversalDataDBHelper() {
        return reversalDataDB;
    }
    ...
    public static QrDataDB getQrDataDHelper() {
        return qrDataDB;
    }
